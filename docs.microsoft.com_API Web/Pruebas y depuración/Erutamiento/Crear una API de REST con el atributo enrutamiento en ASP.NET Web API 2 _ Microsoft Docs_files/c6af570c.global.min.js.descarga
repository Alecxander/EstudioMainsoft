...
var contentLoaded = new Promise(function (resolve) {
    if (document$1.readyState === 'loading') {
        document$1.addEventListener('DOMContentLoaded', function () { return resolve(); });
    }
    else {
        resolve();
    }
...
var loc = {
    ...
    "apiReference": "Referencia de la API de {0}",
    "apiSearchIsUnavailable": "La búsqueda de API no está disponible. Vuelva a intentarlo más tarde.",
    "applies.to": "Se aplica a:",
    "archiveDocs": "Versiones anteriores",
    "aSecondAgo": "hace un segundo",
    "asia": "Asia",
    "askQuestion": "Hacer una pregunta",
    "author.name": "Nombre del autor",
    "avatar": "Avatar",
    "aWeekAgo": "hace una semana",
    "azureDisclaimer": "Azure Cloud Shell utiliza las suscripciones existentes de Azure. Se puede incurrir en costos asociados al utilizar Cloud Shell y ejecutar comandos.",
    "azureDocs": "Documentación de Azure",
    "back.to.top": "Volver al principio",
    "body": "Cuerpo",
    "breadcrumb": "Ruta de navegación",
    "caution": "Precaución",
    "change.page.locale": "Cambiar idioma de página",
    "chooseReaction": "Elegir reacción",
    "clearfilter": "Borrar filtro",
    "clearterm": "Borrar término",
    "clickForRSS": "Hacer clic para la fuente RSS",
    "close": "Cerrar",
    "closedIssue": "Problema cerrado",
    "closedIssues": "Problemas cerrados",
    "cloudShell.accountError": "Error al acceder a su cuenta de Azure.",
    "cloudShell.chooseAccount": "Elija una de sus cuentas de Azure.",
    "cloudShell.loggingIn": "Iniciado sesión en Azure Cloud Shell...",
    "cloudShell.pleaseLogin": "Para utilizar Azure Cloud Shell, inicie sesión con su cuenta de Azure.",
    "code": "Código",
    "collaborator": "Colaborador",
    "collaboratorDescription": "Se ha invitado a este usuario a colaborar en {repo}.",
    "comment": "Comentario",
    "commentCount": "{0} comentarios",
    "commentPostedFormat": "{name} hizo un comentario {time ago}",
    "comments": "Comentarios",
    "confused": "Confusión",
    "confusedReactionCount": "{0} reacciones de confusión",
    "continueHere": "Continúe aquí",
    "contributor": "Colaborador",
    "contributorDescription": "Este usuario se ha confirmado anteriormente en el repositorio {repo}.",
    "contributorGuide": "Cómo contribuir",
    "contributors": "Colaboradores",
    "cookie.consent.europe": "Al usar este sitio acepta el uso de cookies para análisis, contenido personalizado y publicidad.",
    "copy": "Copiar",
    ...
    "dialogCloseWindow": "Cerrar este cuadro de diálogo",
    "disable": "Deshabilitar",
    "disclaimer.archive": "Este contenido ya no se actualizará periódicamente. Consulte la página del <a href=\"https://support.microsoft.com/en-us/lifecycle/selectindex\">ciclo de vida de productos</a> para obtener información sobre cómo se admite este producto, servicio o tecnología.",
    "disclaimer.archiveMachineTranslated": "Este artículo lo ha traducido una máquina. Este contenido ya no se actualizará periódicamente. Consulte la página del <a href=\"https://support.microsoft.com/en-us/lifecycle/selectindex\">ciclo de vida de productos</a> para obtener información sobre cómo se admite este producto, servicio o tecnología.",
    "disclaimer.archiveRetire": "Este contenido se ha eliminado y no se volverá a actualizar.  El producto, el servicio o la tecnología mencionados en este contenido ya no son compatibles.",
    "disclaimer.archiveRetireMachineTranslated": "Este artículo lo ha traducido una máquina. Este contenido se ha eliminado y no se volverá a actualizar.  El producto, el servicio o la tecnología mencionados en este contenido ya no son compatibles.",
    "disclaimer.dismissAlert": "Descartar alerta",
    "disclaimer.machineTranslatedOnly": "Partes de este tema que pueden traducirse automáticamente. Puede sugerir una traducción mejor haciendo clic en el botón Editar. Las instrucciones se encuentran en la <a href=\"https://docs.microsoft.com/en-us/contribute/\">guía de colaboración</a>.",
    "disclaimer.moniker": "Esta API no se admite en el marco de trabajo seleccionado actualmente.",
    "disclaimer.recommendedVersion": "Versión recomendada",
    "disclaimer.returnToMain": "Volver al sitio principal",
    "disclaimer.sxs.human": "Puede mostrar el texto en inglés en una ventana emergente moviendo el cursor del mouse sobre el texto.",
    "disclaimer.sxs.machine": "Este artículo lo ha traducido una máquina. Puede mostrar el texto en inglés en una ventana emergente moviendo el cursor del mouse sobre el texto.",
    "disclaimer.text": "Este contenido no está disponible en su idioma. Esta es la versión en inglés.",
    "disclaimerSearchPreviousVersions": "Los resultados de la búsqueda corresponden a la documentación de versiones anteriores, que ya no se actualiza con regularidad.",
    "documentDetails": "Detalles del documento",
    "doNotEditThis": "No edite esta sección. Se requiere para docs.microsoft.com ➟ Vinculación de problema de GitHub.",
    "dotnetDocs": "Documentación de .NET",
    "dotnetEditor": "Editor de .NET",
    "downloadPdf": "Descargar PDF",
    "edit": "Editar",
    "editdesc": "Editar este documento",
    "email": "Correo electrónico",
    "emptyNameNotAllowed": "No se permite un nombre vacío",
    "enable": "Habilitar",
    "error": "Error",
    "errorCreatingComment": "Error al crear el comentario. Si lo desea, puede reintentarlo en <a data-bi-name=\"create-comment-on-github\" ms.cmpnm=\"create-comment-on-github\" href=\"{0}\">GitHub <span class=\"docon docon-navigate-external\" aria-hidden=\"true\"></span></a>.",
    "errorCreatingIssue": "Error al crear el problema. Si lo desea, puede reintentarlo en <a data-bi-name=\"create-issue-on-github\" ms.cmpnm=\"create-issue-on-github\" href=\"{0}\">GitHub <span class=\"docon docon-navigate-external\" aria-hidden=\"true\"></span></a>.",
    "errorLoadingComments": "Error al cargar los comentarios.",
    "errorLoadingFeedback": "Error al cargar comentarios.",
    "europe": "Europa",
    "exit": "Salir",
    "expandDocumentationFeedbackMenu": "Expandir el menú de comentarios de la documentación",
    "facebook": "Facebook",
    "feedback": "Comentarios",
    "feedbackPlaceholder": "[Escriba sus comentarios aquí]",
    "feedbackProduct": "Proporcionar comentarios del producto",
    "filter.placeholder": "Filtrar por título",
    "filter.text": "Filtrar",
    "findALanguage": "Buscar un idioma",
    "footer.blog": "Blog",
    "getHelp": "Obtener ayuda",
    "giveDocumentationFeedback": "Proporcionar comentarios de la documentación",
    "giveFeedback": "Proporcionar comentarios",
    "giveProductFeedback": "Proporcionar comentarios del producto",
    "greatWork": "Great Work",
    "headers": "Encabezados",
    "heart": "Fascinación",
    "heartReactionCount": "{0} reacciones de fascinación",
    "helpMeChoose": "Ayúdeme a elegir",
    "hooray": "Alegría",
    "hoorayReactionCount": "{0} reacciones de alegría",
    "hoursAgo": "hace {0} horas",
    "important": "Importante",
    "impressum.text": "Impressum",
    "in.this.article": "En este artículo",
    "incorrectChoice": "Incorrect Choice",
    "intuneFeedback": "Comentarios sobre Intune",
    "issueOpenedFormat": "abierto por {name} {time ago}",
    "issueProduct": "Informar de un problema con el producto",
    "justNow": "ahora mismo",
    "landmarkToc": "Tabla de contenido",
    "landmarkTocFilterFormLabel": "Filtrar tabla de contenido",
    "language": "Lenguaje",
    "last.updated": "actualizado",
    "laugh": "Risa",
    "laughReactionCount": "{0} reacciones de risa",
    "learnmore": "Saber más",
    "leaveAComment": "Dejar un comentario",
    "leaveFeedbackDirectly": "También puede dejar sus comentarios <a data-bi-name=\"create-issue-on-github\" href=\"{0}\">directamente en GitHub <span class=\"docon docon-navigate-external\" aria-hidden=\"true\"></span></a>.",
    "light": "Claro",
    "linkedin": "LinkedIn",
    "loading": "Cargando...",
    ...
    "loginAzure": "Inicie sesión con su cuenta de Azure.",
    "mainNavigation": "Navegación principal",
    "maximize": "Maximizar",
    "member": "Miembro",
    "memberDescription": "Este usuario es miembro de la organización {org}.",
    "middleEast": "Oriente Medio",
    "minimize": "Minimizar",
    "minutesAgo": "hace {0} minutos",
    "minuteToRead": "Tiempo de lectura: {0} minutos",
    "moduleReference": "Referencia del módulo de {0}",
    "monikerFallback": "La página solicitada no está disponible para {0}. Se le ha redirigido a la versión más reciente del producto que esta pagina esta disponible.",
    "monthsAgo": "hace {0} meses",
    "more": "Más",
    "msdn.redirection.message": "Se le ha redirigido a esta página desde MSDN.  Estamos en proceso de migrar todo el contenido técnico a docs.microsoft.com.",
    "name": "Nombre",
    "next": "Siguientes",
    "nextPage": "Página siguiente",
    "no.date": "fecha no disponible",
    "no.description": "descripción no disponible",
    "no.results": "No hay resultados",
    "no.search.term": "No hay término para buscar",
    "noOutput": "No hay resultados",
    "note": "Nota",
    "null.option.description": "-- Seleccionar valor --",
    "numberClosedIssues": "Cerrados: {0}",
    "numberOpenIssues": "Abiertos: {0}",
    "officeDocs": "Documentación de Office",
    "onPageNavigation": "En navegación de páginas",
    "onSpecificDate": "el {0}",
    ...
    "output": "Resultados",
    "owner": "Propietario",
    "ownerDescription": "Este usuario es propietario del repositorio {repo}.",
    "pacific": "Pacífico",
    "packageReference": "Referencia de paquete {0}",
    "page": "Página {0}",
    "pageActions": "Acciones de página",
    "parameters": "Parámetros",
    "pickReaction": "Seleccione su reacción",
    "platform": "Plataforma",
    "pleaseFillOut": "Rellene este campo.",
    "pleaseTryAgain": "Please try again.",
    "previous": "Anterior",
    "previousPage": "Página anterior",
    "previousVersionDocs": "Documentación de versiones anteriores",
    "privacy.statement": "Privacidad &amp; cookies",
    "privacystatement": "Declaración de privacidad",
    "product": "Producto",
    "product.feedback": "Para enviar comentarios sobre productos, visite",
    "quickfilters": "Filtros rápidos",
    "quizChallengeCompleted": "{tutorial} quiz challenge complete",
    "quizCompleted": "You completed the {tutorial} quiz challenge.",
    ...
    "quizContinueToNext": "Continue to {nextUnitName}",
    "quizFinishSection": "You have finished this section, continue on to the next part {nextUnitName}.",
    "quizNextUnit": "Next {nextUnitName}",
    "rateLimitedLoadingComments": "No se pueden cargar los comentarios. Se ha excedido el límite de frecuencia de la API de GitHub.",
    "rateLimitedLoadingIssues": "No se pueden buscar problemas. Se ha excedido el límite de frecuencia de la API de GitHub.",
    "readInEnglish": "Leer en inglés",
    "requestPreview": "Vista previa de la solicitud",
    "requestUrl": "URL de solicitud",
    "required": "requerido",
    "resourcesFooter.startups": "Empresas emergentes",
    "resourcesFooter.students": "Estudiantes",
    "resourcesFooter.title": "Recursos",
    "resourcesFooter.videoLearning": "Aprendizaje en vídeo",
    "response.code": "Código de respuesta",
    "response.header": "Encabezado de respuesta",
    "restart": "Reiniciar",
    "results.title": "Resultados de la búsqueda para",
    "rss": "RSS",
    "run": "Ejecutar",
    "sample.request": "Solicitud de ejemplo",
    "sample.response": "Respuesta de ejemplo",
    "search": "Buscar",
    "searchNavigation": "Buscar navegación",
    "searchPreviousVersions": "Buscar versiones anteriores",
    "searchScopeTitle": "El filtro de búsqueda es \"{0}\". Pulse para quitarlo.",
    "secondsAgo": "hace {0} segundos",
    "selectedVersion": "Versión seleccionada",
    "selectLocaleInstructions": "Filtre la lista de idiomas seleccionando una región o escribiendo el nombre del idioma o el código de configuración regional.",
    "selectPackage": "Seleccionar paquete",
    "selectVersion": "Seleccionar versión",
    "serviceUnavailable": "El servicio no está disponible temporalmente. Estamos trabajando en ello.",
    "share": "Compartir",
    "sharedArticleSubject": "[Artículo compartido] {0}",
    "sharedesc": "Compartir este documento",
    "signIn": "Iniciar sesión",
    "signInAzure": "Please sign in with your Azure account.",
    "signingIn": "Iniciando sesión...",
    "signInToComment": "Inicie sesión para comentar",
    "signInToGiveDocumentationFeedback": "Inicie sesión para proporcionar comentarios de la documentación",
    "signInToGiveFeedback": "Inicie sesión para proporcionar comentarios",
    "signInToIncreaseRateLimit": "<a class=\"feedback-sign-in-button\" data-bi-name=\"rate-limit-sign-in\" ms.cmpnm=\"rate-limit-sign-in\" href=\"#\">Inicie sesión</a> para aumentar el límite de frecuencia de la API de GitHub.",
    "signInToReact": "Inicie sesión para agregar su reacción",
    "signOut": "Cerrar sesión",
    "slack": "Slack",
    "startHere": "Comience aquí",
    "submitFeedback": "Enviar comentarios",
    "suggestionProduct": "Sugerir una idea del producto",
    "terms.of.use": "Términos de uso",
    "test.request": "Solicitud de prueba",
    "theme": "Tema",
    "thereIsCurrentlyNoFeedback": "Ahora mismo no hay comentarios de este documento.",
    "thumbsDownReactionCount": "{0} reacciones de conformidad",
    "thumbsUpReactionCount": "{0} reacciones de disconformidad",
    "tip": "Sugerencia",
    "title": "Título",
    "toggleIssue": "Alternar problema",
    "trademarks": "Marcas comerciales",
    "try.it": "Pruébelo",
    "tryItDescription": "Pruebe la REST API con las entradas que se indican a continuación.",
    "twitter": "Twitter",
    "version": "Versión",
    "view.source": "Ver código",
    "viewIssueOnGH": "Ver este problema en GitHub",
    "viewMoreOnGitHub": "Ver más comentarios en GitHub",
    "viewOnGitHub": "Ver en GitHub",
    "viewUserOnGH": "Ver {nombre de usuario} en GitHub",
    "visualStudioArchive": "Recomendamos usar Visual Studio 2017.",
    "visualStudioArchiveDownload": "Descargar ahora",
    "visualStudioDocs": "Documentación de Visual Studio",
    "warning": "Advertencia",
    "weeksAgo": "hace {0} semanas",
    "whatTypeOfFeedback": "¿Qué tipo de comentarios quiere proporcionarnos?",
    "windowsDocs": "Documentación de Windows",
    "worldwide": "Todo el mundo",
    "wouldYouLikeToProvideFeedback": "¿Qué tipo de comentarios quiere proporcionarnos?"
};
...
function showArchiveDisclaimer() {
    if (!checkIsArchived())
        return;
    var isMachineTranslated = getMeta('ms.translationtype') === "MT" || getMeta('ms.translationtype') === "MTE";
    ...
    if (visualStudioArchive) {
        ...
        showDisclaimer(visualStudioBanner, { url: "https://aka.ms/upgradevs2017", text: text }, "visual-studio-disc");
    }
    if (archiveUrl) {
...
function getRestProducts() {
    if (!restProductsPromise) {
        ...
        restProductsPromise = fetchWithTimeout(url, { credentials: 'include' })
...
function fetchPlatform(platformId) {
    return platformId === 'rest'
        ? getRestProducts()
            .then(function (data) { return mapSiteSearchToPlatform(data, platformId); })["catch"](function () { return ({ platformId: platformId, displayName: platformId, families: [] }); })
        : fetchWithTimeout(dhsApiBase + "familyTrees/byPlatform/" + encodeURIComponent(platformId))
            .then(function (response) { return response.json(); })
            .then(function (dhsFamlies) { return mapDhsPlatformToPlatform(dhsFamlies, platformId); })["catch"](function () { return ({ platformId: platformId, displayName: platformId, families: [] }); });
}
...
function siteSearch(locale, dataSource, scope, term, skip, take) {
    ...
    var filterExpression = allScopes.map(function (x) { return "scopes/any(t:t eq '" + x + "')"; }).join(' and ');
...
function siteSearchToApiSearch(siteSearchResponse) {
    return {
        ...
        results: siteSearchResponse.results.map(function (y) { return ({
            displayName: y.title,
            url: y.url,
...
function fetchRestNamespaces(platform, moniker) {
    return getRestProducts()
        .then(function (data) { return mapSiteSearchToNamespaceResponse(data, moniker); });
}
function fetchFamilyByMoniker(moniker) {
    return fetchWithTimeout(dhsApiBase + "familyTrees/bymoniker/" + encodeURIComponent(moniker))
        ...
        .then(function (family) { return mapDhsFamilyToFamily(family); })["catch"](function () { return createFamilyFromMoniker(moniker); });
}
    ...
    return {
        ...
        products: dhsFamily.products.map(function (_a) {
            ...
            return {
                ...
                packages: packages.sort(function (a, b) { return b.order - a.order; })
...
function mapSiteSearchToPlatform(response, platformId) {
    return {
        ...
        families: [{
                ...
                products: [{
                        displayName: '',
                        packages: response.map(function (each) { return ({
...
function mapSiteSearchToNamespaceResponse(response, moniker) {
    var apiItems = (response.filter(function (platform) { return (platform.scope || '').toLowerCase() === (moniker || '').toLowerCase(); })[0].services || [])
        .map(function (each) { return ({
        displayName: each.name,
        url: each.url,
        description: each.description
    }); });
    return { apiItems: apiItems };
}
...
function renderInTopicTOC() {
    ...
    for (var _i = 0, headings_1 = headings; _i < headings_1.length; _i++) {
        ...
        var text = getVisibleTextContent(heading);
...
function doApiSearch() {
    ...
    displayLoadingIndicator();
    return Promise.all([search(platformId, moniker, term, msDocs.data.userLocale), getPlatform()])
        .then(function (_a) {
        var result = _a[0], platform = _a[1];
        if (currentSearch !== previousSearch) {
            return;
    ...
    var drawToc = function (json) {
        ...
        var createFilter = function () {
            var $filter = $$1("<form>")
                ...
                .attr('aria-label', loc.landmarkTocFilterFormLabel)
                .submit(function (e) {
                e.preventDefault();
            })
                .append($$1('<input>')
                ...
                .attr('data-bi-name', "toc-filter")
                .attr('id', 'toc-filter')
                .attr('type', 'search')
                .attr('aria-controls', 'filterResults')
                .keypress(function (e) {
                if (e.which === 13) {
                    e.preventDefault();
                    return;
        ...
        if (selectedPath && Array.isArray(selectedPath)) {
            ...
            var selected_1 = toc;
            for (var i_1 = 0; i_1 < selectedPath.length; i_1++) {
                if (!selected_1)
                    break;
                var childIndex = selectedPath[i_1];
        ...
        $$1(function () {
            ...
            try {
                var scrollAmount = $selectedParent.offset().top - $tocHolder.offset().top - 44;
...
function addCodeHeader(block, config, contentDir) {
    ...
    if (interactiveType) {
        ...
        activateButton_1.addEventListener('click', function () {
            ...
            interactiveType.activateCodeBlock(block.element)["catch"](function () { })
                .then(function () {
...
function logout() {
    ...
    return doOAuthFlow(args).then(function () { tokens.value = null; });
}
function renderAuthentication(container) {
    return new Promise(function (resolve) {
        var blockDiv = document.createElement('div');
        blockDiv.classList.add('azure-auth-page');
        var heading = document.createElement('h2');
        heading.textContent = loc.signingIn;
        blockDiv.appendChild(heading);
        var authContainer = document.createElement('div');
        authContainer.classList.add('azure-auth');
        blockDiv.appendChild(authContainer);
        container.appendChild(blockDiv);
        var processTokens = function (tokens) {
            if (tokens === null) {
                renderLoginButton(authContainer, processTokens);
            }
                ...
                renderTokenSelector(authContainer, resolve, tokens, blockDiv);
            }
        };
        renderLoadingProgress(authContainer);
        tryLoadTokens().then(function () { return processTokens(tokens.value); });
    });
}
function renderLoginButton(container, processTokens) {
    container.innerHTML = '';
    var label = document.createElement('p');
    label.textContent = loc.signInAzure;
    ...
    loginButton.classList.add('small');
    loginButton.textContent = loc.signIn;
...
function renderLoadingProgress(container) {
...
function renderTokenSelector(container, resolve, tokens, parentContainer) {
    container.innerHTML = '';
    var tokensBlockDiv = document.createElement('div');
    tokensBlockDiv.classList.add('auth-tokens');
    var label = document.createElement('h3');
    label.textContent = loc['cloudShell.chooseAccount'];
    tokensBlockDiv.appendChild(label);
    var _loop_1 = function (token) {
        ...
        tokensBlockDiv.appendChild(button);
    };
    for (var _i = 0, tokens_1 = tokens; _i < tokens_1.length; _i++) {
        var token = tokens_1[_i];
        _loop_1(token);
    }
    container.appendChild(tokensBlockDiv);
}
function reportAuthorized() {
    ...
    jsllReady.then(function (awa) {
        return awa.ct.capturePageAction(_this.element, {
            ...
            actionType: awa.actionType.OTHER,
            contentTags: (_a = {},
                _a[contentTags.scenario] = 'azure-auth-login',
...
function createForTutorial(isPowerShell) {
    ...
    panel.innerHTML = "\n\t\t<div class=\"panel-header\">\n\t\t\t<button class=\"flat-button refresh\" data-bi-name=\"restart\">\n\t\t\t\t<span class=\"visually-hidden\">" + escape$1(loc.restart) + "</span>\n\t\t\t</button>\n\t\t\t<a class=\"flat-button feedback\" data-bi-name=\"feedback\" href=\"https://aka.ms/cloudshellfeedback\">\n\t\t\t\t<span class=\"visually-hidden\">" + escape$1(loc.feedback) + "</span>\n\t\t\t</a>\n\t\t\t<h2>" + escape$1(cloudShell.title) + "</h2>\n\t\t</div>";
...
registerInteractiveType({
    ...
    createForTutorial: function () {
        ...
        var h3 = document$1.createElement('h3');
        h3.classList.add('language');
        h3.innerHTML = '&lrm;' + dotnetOnline.title;
        ...
        runButton.onclick = function () {
            ...
            dotnetOnline.run()["catch"](function () { })
                .then(function () {
...
function wrapCodeBlock(codeBlock) {
    ...
    Object.defineProperty(codeBlock, 'hidden', {
        get: function () { return wrapper.hidden; },
        set: function (value) { return wrapper.hidden = value; }
    });
...
var DotNetOnline =  (function () {
    function DotNetOnline(language, code) {
        ...
        this.ready = this.waitForMessage('HostListenerReady')
            ...
            .then(function () { loader.hidden = true; outputPanel.hidden = false; _this.editor.hidden = false; })["catch"](function (err) {
...
var EventBus =  (function () {
    ...
    EventBus.prototype.subscribe = function (eventType, callback) {
        ...
        return function () { return _this.unsubscribe(eventType, callback); };
    };
...
function renderParam(container, bus, param, isHeaders, urlParams) {
    if (isHeaders === void 0) { isHeaders = true; }
    ...
    return { label: label, valueInput: valueInput, delButton: delButton, li: li };
}
function renderEmptyParam(container, bus, isHeaders) {
    ...
    var addEmptyParam = function (event) {
        ...
        li.parentElement.removeChild(li);
        bus.publish(new RestAddParamEvent({ name: name, value: value, type: 'string', "in": inType, isRequired: false }));
    };
    addButton.onclick = function (event) {
        addEmptyParam(event);
    };
    return { nameInput: nameInput, valueInput: valueInput, addButton: addButton, li: li };
}

var loadSubscriptions = function (bus) {
    bus.publish(new RestSubscriptionIdLoading());
    var request = new Request(subscriptionUrl, { mode: 'cors' });
    if (token === null) {
    ...
    return fetch(request)
        .then(function (response) {
        if (!response.ok) {
            response.text().then(function (text) { throw new Error("error fetching subscriptions:\n\n" + text); });
            bus.publish(new RestSubscriptionIdLoaded([]));
            return false;
        }
...
function renderHttpRequest(container, bus, request) {
    ...
    container.appendChild(blockDiv);
    syntaxHighlight([{ code: codeBlock.textContent, language: 'http', highlightLines: '' }]).then(function (results) {
...
function renderParamList(container, bus, params, isHeaders, urlParams) {
    ...
    var handleAddParam = function (event) {
        if (event.param["in"] === 'header' && isHeaders ||
            event.param["in"] !== 'header' && !isHeaders) {
...
function parseRequestUrl(path) {
    ...
    return { url: url$1, urlParams: urlParams };
}
...
function renderResponseComponent(container, code, isHeader) {
    ...
    blockDiv.appendChild(codeBlock);
    container.appendChild(blockDiv);
    syntaxHighlight([{ code: codeBlock.textContent, language: isHeader ? 'http' : 'json', highlightLines: '' }]).then(function (results) {
        codeBlock.innerHTML = results[0].html;
    });
}
...
function expandActionPanel() {
    ...
    setTimeout(function () { return html.add('ap-layout-in'); }, 20);
    var finish = function () {
        actionPanel$1.removeEventListener('transitionend', finish);
        html.remove('ap-layout-animates');
        html.add('ap-layout-finished');
        notifyContentUpdated();
        restoreScroll(primaryHolder);
    };
    actionPanel$1.addEventListener('transitionend', finish);
    return actionPanel$1;
}
...
function snapshotScroll() {
    ...
    var _loop_1 = function (i) {
        ...
        if (top <= 5 || i === 0) {
            ...
            return { value: function (scrollableParent) {
...
function ensureActionPanel() {
    ...
    actionPanel$1 = document.createElement('div');
    actionPanel$1.classList.add('action-panel');
    document.body.appendChild(actionPanel$1); 
    var collapseButton = document.createElement('button');
    collapseButton.textContent = loc.exit;
    collapseButton.classList.add('docon');
    collapseButton.classList.add('docon-exit-mode');
    collapseButton.classList.add('action-panel-controls');
    collapseButton.classList.add('button-border');
    collapseButton.onclick = collapseActionPanel;
    document.body.insertAdjacentElement('afterbegin', collapseButton); 
}
...
function buildRestTryItRequest(restApiData) {
    ...
    if (restApiData.httpVerb === 'PUT' || restApiData.httpVerb === 'POST') {
        restTryItRequest.headers.push({ name: 'Content-Type', value: 'application/json', type: 'string', "in": 'header', isRequired: true });
    }
    restApiData.requestHeader.forEach(function (header) {
        if (header["in"] === 'header') {
            restTryItRequest.headers.push({ name: header.name, value: '', type: header.type, "in": header["in"], isRequired: header.isRequired });
        }
    });
    restApiData.uriParameters.forEach(function (uriParam) {
        if (uriParam["in"] === 'path' || uriParam["in"] === 'query') {
            restTryItRequest.params.push({ name: uriParam.name, value: '', type: uriParam.type, "in": uriParam["in"], isRequired: uriParam.isRequired });
        }
    });
...
function renderLogoutButton(container) {
    ...
    logoutButton.classList.add('grey-light');
    logoutButton.classList.add('button-primary');
    logoutButton.classList.add('small');
...
function renderRestTryIt(container, bus, request) {
    ...
    var handleRunRequest = function (event) {
        ...
        restFetch(bus, httpRequest)
            .then(function (resp) {
            createRestTryitResponse(resp)
                .then(function (tryitResponse) {
...
registerInteractiveType({
    ...
    activateCodeBlock: function (codeBlock) { return activateCodeBlock$1(codeBlock); },
    createForTutorial: function () { return null; }
});
...
function hasClicktale() {
    ...
    return msDocs.data.pageTemplate in clicktaleWhiteList;
}
if (hasClicktale()) {
...
function login$1() {
    ...
    return doOAuthFlow(args)
        ...
        .then(function (t) { token$1.value = t; }, function (reason) { token$1.value = null; throw reason; });
}
...
function githubRequest(relativeUrl, init) {
    ...
    if (token$1.value !== null && !/^search/.test(relativeUrl)) {
        request.headers.set('Authorization', "token " + token$1.value);
    }
    return request;
}
...
function processRateLimit(response, isSearch) {
    ...
    if (response.status === 403 && rate.remaining === 0) {
        var error = new RateLimitExceededError(rate.reset, rate.limit, !!token$1.value, isSearch);
...
function getReactionButtonHtml(type, count, ownerId, ownerType, displayCount) {
    ...
    var disabled = token$1.value ? '' : 'disabled';
...
function initReactions(container) {
    ...
    window$1.addEventListener(tokenChangedEvent, function () {
        Array.from(container.querySelectorAll('.github-reaction'))
            .forEach(function (el) { return el.disabled = !token$1.value; });
        Array.from(container.querySelectorAll('.github-reactions-dropdown .feedback-sign-in-button'))
            .forEach(function (el) { return el.hidden = !!token$1.value; });
    });
}
...
function createIssueListItem(issue) {
    ...
    var openedWhenBy = escape$1(loc.issueOpenedFormat)
        ...
        .replace('{name}', "<a class=\"issue-author\" href=\"" + issue.user.html_url + "\" " + nm('github-issue-user') + " title=\"" + viewAuthorTip + "\">" + issue.user.login + "</a>");
...
function formatIssueBody(body) {
    ...
    var documentId = context.documentId, versionIndependentDocumentId = context.versionIndependentDocumentId, documentSourceUrl = context.documentSourceUrl, service = context.service, contentTitle = context.contentTitle;
    var documentSourceTitle = documentSourceUrl
...
var isMachineTranslation = getMeta('ms.translationtype') === 'MT' || getMeta('ms.translationtype') === 'MTE';
var isSideBySideTranslation = getMeta('bilingual_type') === 'hover over';
function displayTranslations() {
    if (checkIsArchived() && !isSideBySideTranslation) {
        return;
    }
    var pageTemplate = msDocs.data.pageTemplate;
    if (isMachineTranslation && !isSideBySideTranslation) {
        showDisclaimer(loc['disclaimer.machineTranslatedOnly']);
        return;
    }
    if (!isSideBySideTranslation
        || isMobileOrTablet
...
function handleEngContentToggle(container) {
    var content = document.querySelector('.primary-holder > .content');
    var languageToggle = document.getElementById('language-toggle');
    if (!isMachineTranslation || !isSideBySideTranslation || !languageToggle) {
        return;
    }
    languageToggle.addEventListener('change', function (e) {
        ...
        toggleContentLanguage(isChecked, languageConfig);
        renderInTopicTOC();
        notifyContentUpdated();
    });
...
function toggleContentLanguage(toEnglish, _a) {
    ...
    if (toEnglish) {
        localizedElements.forEach(function (elt) { return elt.style.display = 'none'; });
        sxslookupElements.forEach(function (elt) { return elt.style.display = 'inline'; });
        content.lang = 'en-us';
        content.dir = 'ltr';
        if (isSideBySideTranslation) {
            localStorage$1.setItem('translations-enabled', '0');
        ...
        localizedElements.forEach(function (elt) { return elt.style.display = 'inline'; });
        sxslookupElements.forEach(function (elt) { return elt.style.display = 'none'; });
...
function handleHeadings(container) {
    ...
    headings.forEach(function (heading) {
        if (heading.parentElement.matches("" + allowParents.join(','))) {
            ...
            var id = heading.id || getVisibleTextContent(heading).split(' ').join('-');
...
function searchPage() {
    ...
    if (searchValue.length > 0) {
        ...
        $.ajax({
            ...
            $('.searchPage h1').after('<div class="feed-rss"><a href="' + rssPath + params + '" class="link-rss" aria-label="' + loc.clickForRSS + '"><i class="icon icon-rss"></i><span class="visually-hidden-tablet">' + loc.rss + '</span></a></div>');
            resultsDiv.empty();
            if (data.count > 0) {
                ...
                data.results.forEach(function (r) {
                    ...
                    html.push("<div><a data-bi-name='searchItem." + index + "' href='" + r.url + "' class='title'>" + escape$1(r.title) + "</a>");
                    if (r.breadcrumbs !== undefined && r.breadcrumbs.length > 0) {
                        html.push("<ul>");
                        r.breadcrumbs.forEach(function (obj) {
                            html.push("<li><a data-bi-name='searchItem." + index + ".breadcrumb' href='" + obj.url + "'>" + escape$1(obj.name) + "</a></li>");
                        });
                        html.push("</ul>");
                    }
...
var prodServerUrl = 'https://docslearning.azurewebsites.net';
var developServerUrl = 'https://docslearning-ppe.azurewebsites.net';
function getUnitProgress(userId, unitId) {
    var url = getServerUrl() + "/progress/units/" + unitId;
    var init = { method: 'GET', headers: { userId: userId } };
...
function putUnitProgress(userId, unitId, stepId) {
    var url = getServerUrl() + "/progress/units/" + unitId + "/steps/" + stepId;
    var currentTime = new Date().toISOString();
    var body = "{\n\t\t\"uid\": \"" + stepId + "\",\n\t\t\"type\": 'normalStep',\n\t\t\"isCompleted\": true,\n\t\t\"completedTime\": \"" + currentTime + "\"\n\t}";
    var init = { method: 'PUT', headers: { userId: userId }, body: body };
    return fetchWithTimeout(createRequest(url, init))
        .then(function (response) { return response.json(); });
}
function getQuiz(quizId) {
    var url = getServerUrl() + "/quizzes/" + quizId;
    var init = { method: 'GET', headers: { quizId: quizId } };
    return fetchWithTimeout(createRequest(url, init))
        .then(function (response) { return response.json(); });
}
function checkQuiz(userId, unitId, quizId, selectedAnswerData) {
    var url = getServerUrl() + "/progress/units/" + unitId + "/steps/" + quizId;
    var init = { method: 'PUT', headers: { userId: userId }, body: JSON.stringify(selectedAnswerData) };
    return fetchWithTimeout(createRequest(url, init))
        .then(function (response) { return response.json(); });
}
...
function getServerUrl() {
    ...
    if (hostname === 'localhost' || hostname === 'review.docs.microsoft.com' || hostname === 'ppe.docs.microsoft.com') {
...
var Dialog =  (function () {
    ...
    Dialog.prototype.hide = function () {
        ...
        Array.from(document$1.body.querySelectorAll('.tab-sentinel'))
...
var QuizRetrieveSelectedAnswerData =  (function () {
    function QuizRetrieveSelectedAnswerData(selectedAnswerData) {
        this.selectedAnswerData = selectedAnswerData;
    }
    return QuizRetrieveSelectedAnswerData;
}());
var QuizCheckAnswer =  (function () {
    function QuizCheckAnswer(gradedQuestionData) {
        this.gradedQuestionData = gradedQuestionData;
    }
    return QuizCheckAnswer;
}());
function renderQuestion(container, bus, question) {
    var divBlock = document.createElement('div');
    var titleBlock = document.createElement('div');
    var questionIdSpan = document.createElement('span');
    questionIdSpan.textContent = (question.id + 1).toString();
    questionIdSpan.classList.add('question-id');
    questionIdSpan.classList.add('question-id-unselected');
    titleBlock.appendChild(questionIdSpan);
    var titleDesc = document.createElement('div');
    titleDesc.classList.add('question-title');
    titleDesc.innerHTML += question.content;
    titleBlock.appendChild(titleDesc);
    divBlock.appendChild(titleBlock);
    var selectedChoiceId = null;
    var choiceBlock = document.createElement('div');
    choiceBlock.classList.add('choice-section');
    question.choices.forEach(function (choice) {
        var choiceLabel = document.createElement('label');
        choiceLabel.classList.add('choice-group');
        var choiceInput = document.createElement('input');
        choiceInput.setAttribute('type', 'radio');
        choiceInput.setAttribute('name', question.id.toString());
        choiceInput.value = choice.id.toString();
        ...
        choiceSpan.classList.add('choice-letter');
        choiceSpan.textContent = String.fromCharCode('A'.charCodeAt(0) + choice.id);
        choiceLabel.appendChild(choiceSpan);
        choiceLabel.innerHTML += choice.content;
        choiceLabel.onclick = function (event) {
            resetChoiceStatus(choiceBlock);
            resetQuestionStatus(titleBlock);
            selectedChoiceId = parseInt(choiceInput.value);
            choiceLabel.querySelector('span').classList.add('choice-selected');
            questionIdSpan.classList.add('question-id-selected');
        };
        choiceBlock.appendChild(choiceLabel);
    });
    divBlock.appendChild(choiceBlock);
    container.appendChild(divBlock);
    bus.subscribe(QuizRetrieveSelectedAnswerData, function (_a) {
        var selectedAnswerData = _a.selectedAnswerData;
        var selectedChoices = [];
        if (selectedChoiceId !== null) {
            selectedChoices.push(selectedChoiceId);
        }
    ...
    bus.subscribe(QuizCheckAnswer, function (_a) {
        var gradedQuestionData = _a.gradedQuestionData;
        var gradedQuestion = gradedQuestionData.filter(function (item) { return item.id === question.id; })[0];
        var spanChoice = choiceBlock.children[selectedChoiceId].querySelector('span');
        resetChoiceStatus(choiceBlock);
        resetQuestionStatus(titleBlock);
        if (!gradedQuestion.isCorrect) {
            titleDesc.classList.add('question-incorrect');
            questionIdSpan.classList.add('question-incorrect');
            titleDesc.setAttribute('title', loc.pleaseTryAgain);
            spanChoice.textContent = '';
            spanChoice.classList.add('docon');
            spanChoice.classList.add('docon-math-multiply');
            spanChoice.classList.add('choice-incorrect');
            spanChoice.setAttribute('aria-label', loc.incorrectChoice);
        }
        else {
            questionIdSpan.classList.add('question-correct');
            spanChoice.textContent = '';
            spanChoice.classList.add('docon');
            spanChoice.classList.add('docon-check');
            spanChoice.classList.add('choice-correct');
            spanChoice.setAttribute('aria-label', loc.correctChoice);
        }
    });
    return { titleDesc: titleDesc, choiceBlock: choiceBlock };
}
function resetChoiceStatus(choiceBlock) {
    for (var i = 0; i < choiceBlock.children.length; i++) {
        var spanChoice = choiceBlock.children[i].querySelector('span');
        spanChoice.classList.remove('choice-selected');
        spanChoice.classList.remove('choice-correct');
        spanChoice.classList.remove('choice-incorrect');
        spanChoice.classList.remove('docon');
        spanChoice.classList.remove('docon-math-multiply');
        spanChoice.classList.remove('docon-check');
        spanChoice.textContent = String.fromCharCode('A'.charCodeAt(0) + i);
    }
}
function resetQuestionStatus(titleBlock) {
    var questionIdSpan = titleBlock.querySelector('.question-id');
    questionIdSpan.classList.remove('question-id-selected');
    questionIdSpan.classList.remove('question-id-unselected');
    questionIdSpan.classList.remove('question-correct');
    questionIdSpan.classList.remove('question-incorrect');
    var titleDesc = titleBlock.querySelector('.question-title');
    titleDesc.classList.remove('question-correct');
    titleDesc.classList.remove('question-incorrect');
}
...
var unitId$1 = getMeta('uid');
var nextUnitName = null;
function initQuiz(loginUserId) {
    return getQuiz(quizId).then(function (data) {
        userId$1 = loginUserId;
        var mainContainer = document.querySelector('main');
        var lastSection = mainContainer.lastElementChild;
        ...
        renderQuiz(quizForm, data, quizId);
        quizSection.appendChild(quizForm);
        mainContainer.insertBefore(quizSection, lastSection);
    });
}
var isSubmitting = false;
function renderQuiz(container, quiz, id) {
    formContainer = container;
    var bus = new EventBus();
    var divBlock = document.createElement('div');
    var quizTitle = document.createElement('h2');
    quizTitle.innerHTML = quiz.title;
    if (quizTitle.firstElementChild instanceof HTMLParagraphElement && quizTitle.childElementCount === 1) {
        quizTitle.innerHTML = quizTitle.firstElementChild.innerHTML;
    }
    divBlock.appendChild(quizTitle);
    quiz.questions.forEach(function (question) {
        renderQuestion(divBlock, bus, question);
    });
    container.appendChild(divBlock);
    var checkChallengeButton = renderCheckChallengeButton(container);
    configureValidation(container);
    isSubmitting = false;
    container.onsubmit = function (event) {
        if (isSubmitting) {
        ...
        isSubmitting = true;
        submitQuizChallenge(checkChallengeButton, bus);
        event.preventDefault();
    };
    return divBlock;
}
function renderCheckChallengeButton(container) {
    var checkButton = document.createElement('button');
    checkButton.classList.add('button-primary');
    checkButton.classList.add('blue');
    checkButton.setAttribute('type', 'submit');
    checkButton.setAttribute('data-bi-name', 'learn-quiz-validate');
    checkButton.textContent = 'Check Challenge';
    container.appendChild(checkButton);
    return checkButton;
}
function submitQuizChallenge(checkButton, bus) {
    checkButton.classList.add('busy');
    var selectedAnswerData = [];
    bus.publish(new QuizRetrieveSelectedAnswerData(selectedAnswerData));
    checkQuiz(userId$1, unitId$1, quizId, selectedAnswerData)
        .then(function (data) {
        if (data.isUpdated) {
            nextUnitName = data.next.title;
            var gradedQuestionsCorrect = selectedAnswerData.map(function (item) { return ({
                id: item.id,
                isCorrect: true,
                choices: [{
                        id: item.answers[0],
            ...
            bus.publish(new QuizCheckAnswer(gradedQuestionsCorrect));
            displayGreetingDialog();
            reportChallengeResult(gradedQuestionsCorrect, bus, data.isUpdated);
            getProgressRemote(unitId$1);
        }
        else {
            bus.publish(new QuizCheckAnswer(data.validationResponse));
            reportChallengeResult(data.validationResponse, bus, data.isUpdated);
        }
        checkButton.classList.remove('busy');
        isSubmitting = false;
    });
}
function reportChallengeResult(gradedQuestions, bus, passed) {
    var gradedQuestionForBi = gradedQuestions.map(function (item) { return ({
        id: item.id,
    ...
    jsllReady.then(function (awa) {
        awa.ct.captureContentPageAction({
            ...
            actionType: awa.actionType.OTHER,
            content: {
                'type': 'learn-quiz-validated',
                'uid': quizId,
                'passed': passed,
                'questions': JSON.stringify(gradedQuestionForBi)
            }
        });
    });
}
function displayGreetingDialog() {
    var dialogBlock = document.createElement('div');
    dialogBlock.classList.add('achieve-dialog');
    var closeButton = document.createElement('button');
    closeButton.classList.add('docon');
    closeButton.classList.add('docon-math-multiply');
    closeButton.classList.add('close-button');
    dialogBlock.appendChild(closeButton);
    closeButton.addEventListener('click', function () {
        dialog.hide();
        renderQuizComplete();
    });
    var greetTitle = document.createElement('h2');
    greetTitle.textContent = loc.greatWork;
    dialogBlock.appendChild(greetTitle);
    var greetText = document.createElement('h3');
    greetText.textContent = loc.quizCompleted.replace('{tutorial}', tutorialName);
    dialogBlock.appendChild(greetText);
    var greetIcon = document.createElement('span');
    greetIcon.classList.add('docon');
    greetIcon.classList.add('docon-status-success-outline');
    greetIcon.classList.add('achieve-icon');
    greetIcon.setAttribute('aria-hidden', 'true');
    dialogBlock.appendChild(greetIcon);
    var continueText = document.createElement('span');
    continueText.classList.add('continue-text');
    continueText.textContent = loc.quizFinishSection.replace('{nextUnitName}', nextUnitName);
    dialogBlock.appendChild(continueText);
    var dialog = new Dialog();
    var nextAnchor = document.createElement('a');
    nextAnchor.setAttribute('href', '');
    nextAnchor.classList.add('button-primary');
    nextAnchor.classList.add('green');
    nextAnchor.addEventListener('click', function () {
        dialog.hide();
    });
    nextAnchor.textContent = loc.quizNextUnit.replace('{nextUnitName}', nextUnitName);
    dialogBlock.appendChild(nextAnchor);
    dialog.show(dialogBlock, { modal: true, customizeCloseButton: true });
}
function renderQuizComplete() {
    formContainer.innerHTML = '';
    var divBlock = document.createElement('div');
    divBlock.classList.add('complete-section');
    var completeTitle = document.createElement('h2');
    completeTitle.textContent = loc.quizChallengeCompleted.replace('{tutorial}', tutorialName);
    var completeIcon = document.createElement('span');
    completeIcon.classList.add('docon');
    completeIcon.classList.add('docon-check');
    completeIcon.classList.add('complete-icon');
    completeIcon.setAttribute('aria-hidden', 'true');
    completeTitle.appendChild(completeIcon);
    divBlock.appendChild(completeTitle);
    var completeText = document.createElement('div');
    completeText.textContent = loc.quizCompletedText.replace('{tutorial}', tutorialName).replace('{nextUnitName}', nextUnitName);
    divBlock.appendChild(completeText);
    var continueButton = document.createElement('button');
    continueButton.classList.add('button-primary');
    continueButton.classList.add('green');
    continueButton.textContent = loc.quizContinueToNext.replace('{nextUnitName}', nextUnitName);
    continueButton.addEventListener('click', function (event) {
        event.preventDefault();
    });
    divBlock.appendChild(continueButton);
    formContainer.appendChild(divBlock);
}
...
var tutorialId = 'section_' + document$1.location.pathname.replace(/[^a-zA-Z\d\s]+/g, "_");
...
function tutorialPage() {
    hasQuiz = getMeta('challenge_uid') === undefined ? false : true;
    if (hasQuiz) {
        quizPromise = initQuiz(userId);
    }
    window.addEventListener('hashchange', function () {
        updateProgressDisplay(tutorialId);
    });
    var contentLoadedHandler = function () {
        if (!msDocs.data.context.chromeless) {
            document$1.querySelector('.tutorialMToc').addEventListener('change', function (event) {
                document$1.location.href = event.target.value;
            });
            var hashnames = setFirstAndLastHashNames(document$1);
            firstHashId = hashnames.firstHashId;
            lastHashId = hashnames.lastHashId;
        }
        displayType = normalizeDisplayType(msDocs.data.tutorialDisplayType);
        updateProgressDisplay(tutorialId);
    };
    if (document$1.readyState === 'loading') {
        document$1.addEventListener('DOMContentLoaded', contentLoadedHandler);
    }
    else {
...
var changeSection = function () {
    if (document$1.location.hash === '#quiz') {
        quizPromise.then(changeSectionInternal);
    }
    else {
        changeSectionInternal();
    }
};
function changeSectionInternal() {
    var newHash = document$1.location.hash;
    var main = document$1.querySelector('#main');
    var primary = document$1.querySelector('.primary-holder');
    var hashIsValidSection = false;
    function showSection(aHash, scrollToSectionTop) {
        if (scrollToSectionTop === void 0) { scrollToSectionTop = false; }
        Array.from(main.querySelectorAll('section'))
            .forEach(function (element) {
            element.style.display = 'none';
            if (element.id === aHash.replace('#', '')) {
                element.style.display = msDocs.data.context.chromeless ? 'flex' : 'inherit';
                ...
                if (scrollToSectionTop) {
                    if (msDocs.data.context.chromeless) {
                        ...
                        primary.setAttribute('scrollTop', '0');
                    }
                }
            }
        });
    ...
    if (!hashIsValidSection) {
        var element = document$1.getElementById(newHash);
        while (element) {
            if (element.parentElement && element.parentElement.tagName === 'section' && element.parentElement.id === 'main') {
                newHash = '#' + element.id;
                showSection(newHash);
                break;
            }
    ...
    if (newHash.indexOf('quiz') === -1) {
        if (!isUserLoggedin) {
            storeProgress(progressLocalStorageName, tutorialId, newHash);
        }
        else {
            var stepId = unitId + '-' + newHash.substr(1);
            putProgressRemote(unitId, stepId);
        }
    }
    if (!msDocs.data.context.chromeless) {
        manageActionColumn(newHash, displayType, firstHashId, lastHashId);
        var tocUl = document$1.querySelector('#sidebarContent>.toc ul');
        Array.from(tocUl.querySelectorAll('li, a'))
            .forEach(function (element) {
            element.classList.remove(selectedHolderName, selectedName);
        });
        Array.from(tocUl.querySelectorAll('a[href="' + newHash + '"]'))
            .forEach(function (element) {
            element.classList.add(selectedName);
            element.parentElement.classList.add(selectedHolderName);
        });
        document$1.querySelector('.tutorialMToc').value = newHash;
        notifyContentUpdated();
    }
}
var showHideFeedback = function (aHash, lastHashId) {
    var productFeedback = Array.from(document$1.querySelectorAll('.product-feedback, .feedback-section'));
    if (aHash === lastHashId) {
        productFeedback.forEach(function (element) {
...
var updateTOCProgress = function (progress) {
    var tocUl = document$1.querySelector('#sidebarContent>.toc ul');
    var selectors = [
        '#sidebarContent>.toc ul',
        '#main ul.learnHowTo',
        '#main ul.youLearned'
    ];
    Object.keys(progress)
        .forEach(function (key) {
        var attrFilter = "a[href=\"" + key + "\"]";
        selectors
            .map(function (selector) {
            return selector + " " + attrFilter;
        })
            .forEach(function (selector) {
            Array.from(tocUl.querySelectorAll(selector))
                .forEach(function (element) {
                element.parentElement.classList.add(completedClassName);
            });
        });
    });
};
var initializeInteractive = (function () {
    var interactiveInitialized = false;
    return function (force) {
        if (!force && interactiveInitialized) {
            return;
        }
        if (interactiveTypes && msDocs.data.tutorialInteractiveType && interactiveTypes[msDocs.data.tutorialInteractiveType]) {
            try {
                var holder = document$1.querySelector('.interactiveHolder');
                holder.classList.add('interactiveType-' + msDocs.data.tutorialInteractiveType.replace(/[^a-zA-Z\d\s]+/g, "_"));
                holder.appendChild(interactiveTypes[msDocs.data.tutorialInteractiveType].createForTutorial());
...
var manageActionColumn = function (aHash, displayType, firstHashId, lastHashId) {
    var displayPageActions = function (showPageActions) {
        if (showPageActions) {
            document$1.documentElement.classList.add('hasPageActions');
            document$1.documentElement.classList.remove('hasTerminal');
        }
        else {
            document$1.documentElement.classList.remove('hasPageActions');
        }
    };
    var displayTerminal = function (showTerminal) {
        if (showTerminal) {
            initializeInteractive();
            document$1.documentElement.classList.add('hasPageActions', 'hasTerminal');
        }
        else {
            document$1.documentElement.classList.remove('hasPageActions', 'hasTerminal');
        }
    };
    switch (displayType) {
        case 'one-column':
            displayPageActions(aHash === lastHashId);
            break;
        case 'two-column':
            if (aHash === firstHashId || aHash === lastHashId || aHash === quizHashId) {
                displayPageActions(aHash === lastHashId);
            }
            else {
...
var updateProgressDisplay = function (tutorialId) {
    if (!isUserLoggedin) {
        var thisProgress = getProgress(progressLocalStorageName, tutorialId);
        if (thisProgress) {
            displayContinueHere();
            if (!msDocs.data.context.chromeless) {
                updateTOCProgress(thisProgress);
            }
        }
        changeSection();
    }
    else {
        getProgressRemote(unitId);
    }
};
var displayContinueHere = function () {
    var learnHowToUl = document$1.querySelector('#main ul.learnHowTo');
    if (learnHowToUl === null) {
        return;
    }
    Array.from(learnHowToUl.querySelectorAll("li > a > span." + continueHereName))
        .forEach(function (element) {
        element.parentElement.removeChild(element);
    });
    var current = learnHowToUl.querySelector("li:not(." + completedClassName + "):first-child a");
    var continueHere = document$1.createElement('span');
    continueHere.classList.add(continueHereName);
    continueHere.textContent = current.previousElementSibling ? loc.startHere : loc.continueHere;
    current.appendChild(continueHere);
};
var setFirstAndLastHashNames = function (element) {
    var tocAnchors = Array.from(element.querySelectorAll('#sidebarContent>.toc ul>li>a'));
    return {
        firstHashId: tocAnchors[0].getAttribute('href'),
        lastHashId: hasQuiz ? tocAnchors[tocAnchors.length - 2].getAttribute('href') : tocAnchors.pop().getAttribute('href')
    };
};
var normalizeDisplayType = function (tutorialDisplayType) {
    return ['one-column', 'two-column'].indexOf(tutorialDisplayType) >= 0
        ? tutorialDisplayType
        : 'one-column';
};
var storeProgress = function (storageKey, objectKey, aHash) {
    var progressObj = localStorage$1.getJsonItem(storageKey) || {};
    progressObj[objectKey] = progressObj[objectKey] || {};
    progressObj[objectKey][aHash] = true;
    localStorage$1.setJsonItem(storageKey, progressObj);
};
var getProgress = function (storageKey, objectKey) {
    var progressObj = localStorage$1.getJsonItem(storageKey);
    return progressObj && progressObj[objectKey];
};
function getProgressRemote(unitId) {
    getUnitProgress(userId, unitId)
        .then(function (data) {
        if (data) {
            var thisProgress = {};
            for (var i = 0; i < data.items.length; i++) {
                thisProgress['#' + data.items[i].uid.replace(unitId + '-', '')] = data.items[i].isCompleted;
                thisProgress['#' + data.items[i].uid.replace(unitId + '.', '')] = data.items[i].isCompleted;
            }
            displayContinueHere();
            if (!msDocs.data.context.chromeless) {
...
function putProgressRemote(unitId, stepId) {
    putUnitProgress(userId, unitId, stepId)
        .then(function (data) {
        if (!data.isUpdated) {
            throw new Error('Update Progress for step ' + stepId + ' is not complete.');
        }
...
function initLiveFyre() {
    if (msDocs.data.userLocale.indexOf('en-') === 0
        ...
        cookieConsent.then(function () { return loadLibrary(relativeToGlobal('js/livefyre-commenting.js')); });
    }
}
...
function attachEvents$2(imageBrowser, imageElement) {
    ...
    imageElement.addEventListener('touchstart', function (event) {
        if (imageBrowser.state.expanded) {
            ...
            Array.from(event.changedTouches).forEach(function (_a) {
                ...
                state.touches.push(Object.assign({}, { identifier: identifier, screenX: screenX, screenY: screenY }));
            });
        }
    });
    imageElement.addEventListener('touchmove', function (event) {
        if (imageBrowser.state.expanded) {
            event.preventDefault();
            var identifiers_1 = state.touches.map(function (x) { return x.identifier; });
            ...
            Array.from(event.changedTouches).forEach(function (touch) {
                ...
                if (index >= 0) {
                    state.touches[index] = Object.assign({}, { identifier: touch.identifier, screenX: touch.screenX, screenY: touch.screenY });
                }
            });
    ...
    imageElement.addEventListener('touchend', function (event) {
        var identifiers = state.touches.map(function (x) { return x.identifier; });
        Array.from(event.changedTouches).forEach(function (_a) {
    ...
    ImageBrowser.prototype.toggleExpand = function (x, y, convertCoordinates) {
        ...
        if (!this.state.expanded) {
            this.state.translationX = !isNaN(x)
                ? Math.min(0, Math.max(this.imageElement.naturalWidth * -1 + this.imageContainer.clientWidth, x))
                : 0;
            this.state.translationY = !isNaN(y)
                ? Math.min(0, Math.max(this.imageElement.naturalHeight * -1 + this.imageContainer.clientHeight, y))
                : 0;
        }
...
function initializeLightBox(mainElement) {
    ...
    elements.forEach(function (elem) {
        ...
        elem.addEventListener('click', function (event) {
            ...
            browser.open(element, event.srcElement, { url: elem.href, alt: elem.querySelector('img').alt });
            new Dialog().show(element, { modal: true });
        });
    });
}
...
function wrapContentTables() {
    var pageTemplate = msDocs.data.pageTemplate.toLowerCase();
    if (!(pageTemplate === 'conceptual') && !(pageTemplate === 'landingpage')) {
        return;
    }
    ...
    window$1.addEventListener('resize', throttle(function (event) { return addBorders(wrappers); }));
    addBorders(wrappers);
}
...
setupDismissAlerts();
$$1(affix);
$$1(function () { return initTabs(document$1.body); });
track();
interceptCopy();
initCookieConsent();
$$1(ensureWbr);
...
$$1(function () { handleHeadings(document$1.querySelector('.content')); });
enableGoogleAnalytics();
$$1(function () { return initDropdowns(document$1.body); });
$$1(function () { return initSharingLinks(document$1.body, location.origin + location.pathname + location.search, document$1.title); });
...
$$1(fixAlerts);
$$1(function () { return initializeLightBox(document$1.querySelector('#main')); });
$$1(wrapContentTables);
$$1(function () {
